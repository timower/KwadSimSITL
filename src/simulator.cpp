...
void Simulator::set_rc_data(std::array<FloatT, 8> data) {
...
uint32_t micros(void) {
    return Simulator::getInstance().micros_passed & 0xFFFFFFFF;
}

uint32_t millis(void) {
    return (Simulator::getInstance().micros_passed / 1000) & 0xFFFFFFFF;
}
